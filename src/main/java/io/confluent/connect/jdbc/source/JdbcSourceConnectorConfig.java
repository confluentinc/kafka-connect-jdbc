...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static final String SCHEMA_NAME_PREFIX_CONFIG = "schema.name.prefix";
  public static final String SCHEMA_NAME_PREFIX_DISPLAY = "Schema Prefix";
  private static final String SCHEMA_NAME_PREFIX_DEFAULT = "";
  private static final String SCHEMA_NAME_PREFIX_DOC = "Prefix to prepend to table names to generate the name of the " +
      "schema used to write data to kafka.";
  ...
  public static ConfigDef baseConfigDef() {
    return new ConfigDef()
        ...
        .define(SCHEMA_NAME_PREFIX_CONFIG, Type.STRING, SCHEMA_NAME_PREFIX_DEFAULT, Importance.HIGH, SCHEMA_NAME_PREFIX_DOC, CONNECTOR_GROUP, 4, Width.MEDIUM, SCHEMA_NAME_PREFIX_DISPLAY);
  }
