...
public class JdbcSourceTaskConversionNanoStringTest extends JdbcSourceTaskTestBase {
  ...
  public void setup() throws Exception {
    super.setup();
    task.start(singleTableWithTimezoneAndNanoEpochTimestampConfig(extendedMapping, timezone));
  }
  ...
  public void testNullableTimestamp() throws Exception {
    ...
    typeConversion("TIMESTAMP", true, null,
                  NanoStringTimestamp.builder().optional().build(),
                   null);
  }
  ...
  private void validateRecords(List<SourceRecord> records, Schema expectedFieldSchema,
    ...
    // System.out.println(expectedFieldSchema.fields());
    assertEquals(expectedFieldSchema, fieldSchema);
    assertEquals(fieldSchema, fieldSchema);
