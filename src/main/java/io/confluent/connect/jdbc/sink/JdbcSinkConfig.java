...
public class JdbcSinkConfig extends AbstractConfig {
  ...
  private static final String
      ...
      + "``kafka``\n"
      + "    Must be a trio representing the Kafka coordinates, defaults to ``" + StringUtils.join(
          DEFAULT_KAFKA_PK_NAMES,
          ","
      ) + "`` if empty.\n"
      + "``record_key``\n"
  ...
  private static final String
      ...
      + "Note that ``"
      + PK_FIELDS
      + "`` is applied independently in the context of which field(s) form the primary key "
  ...
  public static final ConfigDef CONFIG_DEF = new ConfigDef()
      ...
      // Data Mapping
      .define(
          TABLE_NAME_FORMAT, ConfigDef.Type.STRING, TABLE_NAME_FORMAT_DEFAULT,
