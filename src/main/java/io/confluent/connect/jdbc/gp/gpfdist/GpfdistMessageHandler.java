...
import io.confluent.connect.jdbc.gp.gpfdist.framweork.AbstractGpfdistMessageHandler;
import io.confluent.connect.jdbc.gp.gpfdist.framweork.GpfdistServer;
import io.confluent.connect.jdbc.gp.gpfdist.framweork.Message;
...
public class GpfdistMessageHandler extends AbstractGpfdistMessageHandler {
	...
	protected void doWrite(Message<?> message) throws Exception {
		...
		if (payload instanceof String) {
			...
			throw new Exception("message not a String"+message);
		}
	}
