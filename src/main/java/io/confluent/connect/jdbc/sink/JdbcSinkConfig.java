...
public class JdbcSinkConfig extends AbstractConfig {
  ...
  private static final String CONNECTION_URL_DOC =
      "JDBC connection URL.\n"
      + "The protocol portion may be used to specialize the SQL dialect for DDL and upserts.";
  ...
  private static final String AUTO_CREATE_DOC =
      "Whether to automatically create the destination table based on record schema if it is found to be missing, by issuing a ``CREATE`` statement.\n"
      + "Where supported, each column is assigned an appropriate data type for the database, based on the types in the record schema.\n"
